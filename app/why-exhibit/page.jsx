          ...
          <section class="hero">
            <div class="left-side-under-hero">
              ...
              <h2 className="text-lg md:text-xl py-1 font-medium">
                WOFX - Unlock a World of Opportunities
              </h2>
              <p>
                WOFX is your gateway to access a host of industry prospects in
                the domestic and global furniture &amp; design market. Our
                platform offers a transformative experience, providing the tools
                and connections needed to support development in an
                ever-evolving industry landscape.
              </p>
              <p className="text-2xl font-bold">The WOFX Advantage</p>
              <p>
                <strong>Global Exposure:</strong> WOFX enables you to showcase
                your products to a diverse global audience, including brands,
                leading buyers, and decision-makers from India, South Asia, and
                beyond.
              </p>
              <p>
                ...
                chance to collaborate and enhance brand visibility, propelling
              ...
              <p>
                ...
                distributors, importers, real estate developers, buying houses,
              ...
              <p>
                WOFX is more than an expo; it&apos;s a journey towards elevating
                your furniture business to unprecedented heights. Join us at
                WOFX World Furniture Expo and unlock a world of opportunities.
              </p>
            </div>
