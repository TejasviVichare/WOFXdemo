        ...
        <div className='mx-auto   w-full max-w-screen-2xl '>
          ...
          <Slider
            ...
            >
                ...
                <Slider.Slide>
                    <Image src='/assests/countyLogo/21.png' width={160} height={120} alt='a' />
                </Slider.Slide>
                <Slider.Slide>
                    <Image src='/assests/countyLogo/22.png' width={160} height={120} alt='a' />
                </Slider.Slide>
                <Slider.Slide>
                    <Image src='/assests/countyLogo/23.png' width={160} height={120} alt='a' />
                </Slider.Slide>
                <Slider.Slide>
                    <Image src='/assests/countyLogo/24.png' width={160} height={120} alt='a' />
                </Slider.Slide>
                <Slider.Slide>
                    <Image src='/assests/countyLogo/25.png' width={160} height={120} alt='a' />
                </Slider.Slide>
                <Slider.Slide>
                    <Image src='/assests/countyLogo/26.png' width={160} height={120} alt='a' />
                </Slider.Slide>
                <Slider.Slide>
                ...
                <Slider.Slide>
                    <Image src='/assests/countyLogo/31.png' width={160} height={120} alt='a' />
                </Slider.Slide><Slider.Slide>
                    <Image src='/assests/countyLogo/32.png' width={160} height={120} alt='a' />
                </Slider.Slide><Slider.Slide>
                    <Image src='/assests/countyLogo/33.png' width={160} height={120} alt='a' />
                </Slider.Slide><Slider.Slide>
                    <Image src='/assests/countyLogo/34.png' width={160} height={120} alt='a' />
                </Slider.Slide><Slider.Slide>
                    <Image src='/assests/countyLogo/35.png' width={160} height={120} alt='a' />
                </Slider.Slide><Slider.Slide>
                    <Image src='/assests/countyLogo/36.png' width={160} height={120} alt='a' />
                </Slider.Slide><Slider.Slide>
                    <Image src='/assests/countyLogo/37.png' width={160} height={120} alt='a' />
                </Slider.Slide><Slider.Slide>
                    <Image src='/assests/countyLogo/38.png' width={160} height={120} alt='a' />
                </Slider.Slide>
