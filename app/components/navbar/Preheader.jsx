...
function PreHeader() {
  return (
    <div className='mx-auto border-y-rose-500   w-full max-w-screen-2xl' id="prenav">
        ...
        <div className="mt-3 md:mt-0">
          <p className="pre-header-button" style={{ color: "rgb(203 213 225)",  fontSize: "14px", height: "100%", fontWeight: "500", textTransform: "uppercase" }}>
           LOGIN
            &nbsp;
            <span>
              <a className="px-2 py-2 rounded-sm" style={{ background: "#e73e42", color: "white" }} href="https://www.bee2bee.asia/wofx/login">Exhibitor</a>
              &nbsp;&nbsp;&nbsp;&nbsp;<a className="px-2 py-2 rounded-sm" style={{ background: "#66c3d0", color: "white" }} href="https://www.bee2bee.asia/wofx/login">Buyer</a>
            </span>
          </p>
        </div>
      </div>
