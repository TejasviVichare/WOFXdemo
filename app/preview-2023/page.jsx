          ...
          <a href="/assets/pdf/WOFX-PREVIEW-1_press.pdf">
            <div className="border py-4 hover:bg-slate-900">
              ...
              <div className="text-center my-6">
                <p className="text-center py-4 px-0 md:px-2 bg-orange-500 text-white font-semibold" href="/assets/pdf/WOFX-PREVIEW-1_press.pdf">
                  Preview 1
                </p>
              </div>
            </div>
          ...
          <a href="/assets/pdf/WOFX-PREVIEW-2_press.pdf">
            <div className="border py-4 hover:bg-slate-900">
              ...
              <p className="text-center my-6">
                <p className="text-center py-4 px-0 md:px-2 bg-orange-500 text-white font-semibold" href="/assets/pdf/WOFX-PREVIEW-2_press.pdf">
                  Preview 2
                </p>
              </p>
            </div>
