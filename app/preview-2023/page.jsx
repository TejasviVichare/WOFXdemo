      ...
      <div className="flex justify-center">
        <div className="w-4/5 flex justify-center gap-8 mb-8">
          <div className="border py-4 hover:bg-slate-900">
            ...
            <p className="text-center my-6"><Link className="text-center py-4 px-0 md:px-2 bg-orange-500 text-white font-semibold" href='/assets/pdf/WOFX-PREVIEW-1_press.pdf'>Preview 1</Link></p>
          </div>
          <div className="border py-4 hover:bg-slate-900">
            <Image className="post-show-img" src={preImage2} width={400} height='auto' alt='previe-1' />
            <p className="text-center my-6"><Link className="text-center py-4 px-0 md:px-2 bg-orange-500 text-white font-semibold" href='/assets/pdf/WOFX-PREVIEW-2_press.pdf'>Preview 2</Link></p>
          </div>
        </div>
      </div>
    </div>
