      ...
      <div className='mx-auto   w-full max-w-screen-2xl '>
        <div className="mt-20  flex justify-center">
          <div className="space">
            ...
            <p><a style={{ border: "1px solid black" }} className="px-4 py-3 font-semibold text-black bg-gray-300  rounded" href="">LOCATION</a></p>
            <p>&nbsp;</p>
            <p className="font-bold">Bombay Exhibition Center, Mumbai, India</p>
            <div className="flex py-4">
              <div className="w-1/2">
                <Image
                  className="venueImages"
                  src={venueImage}
                  alt="image1"
                />
              </div>
              <iframe className="w-1/2"
