        ...
        <div className='mx-auto   w-full max-w-screen-2xl' >
          <div className={style.maincontainer}>
            <div className={style.nesteddiv}>
              <h3 className='text-xl text-white  font-bold'>ORGANISED BY</h3>
              <Image src={logo} width={185} height='auto' alt="" />
              <p className='text-white' style={{ paddingTop: "13px" }}>309, Parvati Premises, Sun Mill Complex, <br />
                Lower Parel (W), Mumbai - 400 013, India </p>
              <a className='text-white' href="tel:(+91) 022-4037-6700"> <FontAwesomeIcon icon={faPhone} /> (+91) 022-4037-6700</a><br />
              <a className='text-white' href="mailto:contactus@worldexindia.com"> <FontAwesomeIcon icon={faEnvelope} /> contactus@worldexindia.com</a>
            </div>
            
            <div className={style.nesteddiv}>
              <h3 className='text-xl text-white font-bold'>QUICK LINKS</h3>
            ...
            <div className={style.nesteddiv}>
              <h3 className='text-xl text-white font-bold'>ABOUT WOFX</h3>
              <p className='text-white'>WOFX is a professional B2B trade show dedicated exclusively to the furniture + design
                industry in
                India.
          ...
          <center style={{background:"#592556",}} className='text-white py-4'>© WOFX 2025 | All Rights Reserved.</center>
