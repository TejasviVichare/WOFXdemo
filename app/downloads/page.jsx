    ...
    <div className='mx-auto  mt-48  w-full max-w-screen-2xl '>
        <div className="flex justify-center flex-wrap gap-20">
          <div className="relative border px-4 py-4 rounded">
            ...
            <div className="w-full flex justify-center"><a className="text-center py-2 px-4  md:px-16 bg-orange-500 text-white font-semibold"  href="/assests/WOFX-2024-Logo.png" download>Downlaod</a></div>
          </div>
          <div className="relative border px-4 py-4 rounded">
            <center className="h-32"> <Image src={WORLDEX} width={300} height={150} alt="wofx-logo" /></center>
            <div className="w-full flex justify-center"><a className="text-center py-2 px-2 md:px-16 bg-orange-500 text-white font-semibold"  href="/assests/Worldex-Logo.png" download>Downlaod</a></div>
          </div>
        </div>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
